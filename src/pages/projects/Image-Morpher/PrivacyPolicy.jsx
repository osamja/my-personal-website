...
function PrivacyPolicy() {
    return (
        <div style={{color: 'white'}}>
          ...
          <p>
            We store the images uploaded for the morpher to function.  We also stored the final morphed image(s) on our server so the link to the morphed image remains valid.
          </p>
          ...
          <p>
            ...
            We do not share personal information with outside parties except to the extent necessary to accomplish core app functionality.
