    ...
    render() {
        return (
            <div className="PersonalWebsite" style={{color: "#D8D8D8", textAlign: "left", margin: "5%"}}>
                ...
                <p>In summary, this is my tech stack for this website.
                  At the moment, this web application is a front-end app only.</p>

                <ul>
                  <li>UI - React</li>
                  <li>Build - Webpack Config (Bootstrapped using create-react-app)</li>
                  <li>Server side framework - Express JS</li>
                  <li>Hosting provider: Linode</li>
                  <li>Domain provider: Namecheap</li>
