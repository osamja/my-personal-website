export const computationalPhotography = [
    ...
    {
        'src': 'static/images/academic/proj5-face-morphing.jpg',
        'text': 'Face Morphing',
        'url': 'https://inst.eecs.berkeley.edu/~cs194-26/fa16/upload/files/proj5/cs194-26-aeg',
        'redirect': true,
    },
    {
        'src': 'static/images/academic/proj6-lightfield.jpg',
